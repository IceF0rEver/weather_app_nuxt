        ...
        <div>
            <div class=" bg-white rounded-lg p-1 pr-7 py-4 overflow-x-auto">
                ...
                <div class="flex justify-between ml-6 min-w-[500px] sm:min-w-1/3">
                    <div v-for="item in items?.slice(0,10)" :key="item.dt"> 
...
import type { LocationType, WeatherData, WeatherDataHourly } from '@/types/custom-types';
